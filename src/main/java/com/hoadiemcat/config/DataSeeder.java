...
public class DataSeeder implements CommandLineRunner {
    ...
    private void seedMenuItems(Map<String, Category> categoryMap) {
        ...
        List<DishSeed> dishSeeds = List.of(
                new DishSeed("M01", "Lẩu 9 Ngăn Trùng Khánh Đại Hồng Bào", "nuoc-lau", "Vị cay nồng chuẩn Tứ Xuyên với ớt mắt chim, hoa tiêu đỏ và bơ bò hoàng gia ủ 24 giờ", new BigDecimal("389000"), "Nồi 9 ngăn", "https://images.unsplash.com/photo-1569718212165-3a8278d5f624?auto=format&fit=crop&w=400&q=80", true, true, 120L),
                new DishSeed("M02", "Bò Wagyu A5 Cánh Sen Hoàng Triều", "bo-wagyu", "Từng thớ thịt cẩm thạch xếp tạo hình đóa hồng sen vương giả, nhúng chín tới 8 giây", new BigDecimal("890000"), "Khay 250g", "https://images.unsplash.com/photo-1544025162-d76694265947?auto=format&fit=crop&w=400&q=80", true, true, 85L),
                new DishSeed("M03", "Đĩa Ba Chỉ Bò Mỹ Hoa Sơn", "bo-wagyu", "Ba chỉ bò Black Angus thượng hạng với tỷ lệ nạc mỡ đan xen hoàn mỹ, béo ngậy mềm tan", new BigDecimal("220000"), "Khay 300g", "https://images.unsplash.com/photo-1558030006-450675393462?auto=format&fit=crop&w=400&q=80", true, false, 95L),
                new DishSeed("M04", "Thuyền Tôm Càng Hoàng Đế & Đuôi Tôm Hùm", "hai-san", "Tôm hùm Alaska cùng tôm càng xanh tươi rói phục vụ trên thuyền băng tuyết nghệ thuật", new BigDecimal("1450000"), "Thuyền lớn", "https://images.unsplash.com/photo-1565680018434-b513d5e5fd47?auto=format&fit=crop&w=400&q=80", false, true, 42L),
